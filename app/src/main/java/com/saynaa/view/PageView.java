...
public class PageView extends ViewGroup {
  ...
  void populate(int newCurrentItem) {
    ...
    if (curItem != null) {
      ...
      final float leftWidthNeeded = clientWidth <= 0
                                        ? 0
  ...
  public void draw(Canvas canvas) {
    ...
    if (overScrollMode == View.OVER_SCROLL_ALWAYS
        || (overScrollMode == View.OVER_SCROLL_IF_CONTENT_SCROLLS && mAdapter != null
            && mAdapter.getCount() > 1)) {
  ...
  public void fakeDragBy(float xOffset) {
    ...
    final MotionEvent ev = MotionEvent.obtain(
        mFakeDragBeginTime, time, MotionEvent.ACTION_MOVE, mLastMotionX, 0, 0);
    mVelocityTracker.addMovement(ev);
    ev.recycle();
  }
  ...
  public static class SavedState extends BaseSavedState {
    ...
    public String toString() {
      return "FragmentPage.SavedState{" + Integer.toHexString(System.identityHashCode(this))
          + " position=" + position + "}";
    }
  }
